...
public class TypeResolverService {
    ...
    public static <T> String getMyHashcode(T node) {
        try {
            ...
            System.out.println("!!!!!!!!!!!!!!!");
            System.out.println("getMyHashcode에서 에러발생:::" + e.getMessage());
            System.out.println("!!!!!!!!!!!!!!!");
    ...
    private void addRefVariableDto(String hashcode, VariableDeclarationDTO vd) {
        if (variableTypeMapper.addReferenceDto(hashcode, vd)) {
            System.out.println(
                    "add Reference 'VariableDeclartionDto' to Variable TypeMapper, 성공적으로 등록되었습니다!:: " + hashcode);
        } else {
            System.out.println(
                    "add Reference 'VariableDeclartionDto' to Variable TypeMapper, 에러가 발생되었습니다!!:: " + hashcode);
        }
    }
    ...
    public <T> void registerRefDtoService(HashcodeDto hashcodeDto, T someRefDto) {
        System.out.println();
        System.out
                .println("add 'Reference' Dto to TypeMapper Service 시작!::::::: " + hashcodeDto + hashcodeDto.getType());
